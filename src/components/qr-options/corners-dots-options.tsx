    ...
    <AccordionItem value={value}>
      ...
      <AccordionContent className="">
        <div className="flex flex-col gap-1">
          <Label className="input-title">Corners dot Style</Label>
          <Select>
            <SelectTrigger className="w-[180px]">
              <SelectValue placeholder="Select a corners dot style" />
            </SelectTrigger>
            <SelectContent>
              <SelectGroup>
                <SelectLabel>Corners dot style</SelectLabel>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            >
              <Label className="input-title">Corners dot color</Label>
              <input type="color" />
            </TabsContent>
